...
module.exports = client = async (client, m, chatUpdate, store) => {
    try {
        ...
        const { smsg, fetchJson, sleep, formatSize, runtime } = require('./lib/myfunction');     
        const cihuy = fs.readFileSync('./lib/media/laurine-wb.png')
...
command:
 ...
 ▢ ${prefix}eval`
                await client.sendMessage(m.chat, {
                    productMessage: {
                        title: "🪽 — ( xlanzz-wabot: exploration )",
